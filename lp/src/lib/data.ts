...
export const nav = {
  ...
  links: [
    { label: "Watch", href: "/#experience" },
    { label: "Projects", href: "/#projects" },
    { label: "Partners", href: "/#brands" },
    { label: "Host a Camera", href: "/contact?intent=host" },
...
export const hero = {
  ...
  tag: "HARBORMEDIA",
  headlineLine1: "REAL PLACES. / REAL",
  headlineLine2: "MOMENTS. / INTELLIGENTLY",
  headlineLine3: "PUBLISHED.",
  description:
